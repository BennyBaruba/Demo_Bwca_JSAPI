...
require(["esri/map",
    ...
    (Map,Tiled,ArcGISDynamicMapServiceLayer, Extent,
     SpatialReference,FeatureLayer,BasemapToggle,OverviewMap,BasemapGallery,Geocoder,Graphic,SimpleMarkerSymbol,
     SimpleLineSymbol,SimpleFillSymbol,
     Color,InfoTemplate,Query,Circle,UniqueValueRenderer,Geoprocessor,FeatureSet,LinearUnit,graphicsUtils,parser,on, dom) {
